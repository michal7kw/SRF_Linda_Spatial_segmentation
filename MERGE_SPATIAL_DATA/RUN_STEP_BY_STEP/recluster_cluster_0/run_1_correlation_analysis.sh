...
python /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Spatial_segmentation/MERGE_SPATIAL_DATA/SCRIPTS/inclusive/recluster/1_correlation_analysis.py
exit_code=$?
