#!/bin/bash
#SBATCH --job-name=run_2_spatial_analysis_inclusive
#SBATCH --output=logs/run_2_spatial_analysis_inclusive.out
#SBATCH --error=logs/run_2_spatial_analysis_inclusive.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
cd "/beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Spatial_segmentation/MERGE_SPATIAL_DATA"
...
python /beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Spatial_segmentation/MERGE_SPATIAL_DATA/SCRIPTS/inclusive/2_hippo_analysis.py
exit_code=$?
