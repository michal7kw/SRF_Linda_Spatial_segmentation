#!/bin/bash
#SBATCH --job-name=run_8_merker_genes_dotplot
#SBATCH --output=logs/run_8_merker_genes_dotplot.out
#SBATCH --error=logs/run_8_merker_genes_dotplot.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
Rscript MERGE_SPATIAL_DATA/SCRIPTS/plot_marker_genes_dotplot.R
