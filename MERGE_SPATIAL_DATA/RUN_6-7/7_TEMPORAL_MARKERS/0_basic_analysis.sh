...
mkdir -p MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis
mkdir -p logs
...
if [ $? -eq 0 ]; then
    ...
    echo "- Individual 0_basic_analysis: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis/"
    echo "- Volcano plots: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis/volcano_plot_*.png"
    echo "- Heatmaps: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis/heatmap_*.png"
    echo "- Combined 0_basic_analysis: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis/combined_de_results_all_timepoints.csv"
    echo "- Summary statistics: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/0_basic_analysis/summary_statistics.csv"
    echo "================================================================"
else
    echo "================================================================"
