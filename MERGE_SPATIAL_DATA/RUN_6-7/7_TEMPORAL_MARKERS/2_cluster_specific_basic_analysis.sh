#!/bin/bash
#SBATCH --job-name=2_cluster_specific_basic_analysis
#SBATCH --output=logs/2_cluster_specific_basic_analysis.out
#SBATCH --error=logs/2_cluster_specific_basic_analysis.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis
mkdir -p logs
...
python MERGE_SPATIAL_DATA/RUN_6-7/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis.py
...
if [ $? -eq 0 ]; then
    ...
    echo "- Individual cluster results: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/"
    echo "- Volcano plots: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/volcano_plot_*_cluster_*.png"
    echo "- Heatmaps: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/heatmap_*_cluster_*.png"
    echo "- Combined results: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/combined_cluster_de_results_all_timepoints.csv"
    echo "- Cluster summary: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/cluster_summary_statistics.csv"
    echo "- Summary plots: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/2_cluster_specific_basic_analysis/cluster_analysis_summary.png"
    echo "================================================================"
else
    echo "================================================================"
