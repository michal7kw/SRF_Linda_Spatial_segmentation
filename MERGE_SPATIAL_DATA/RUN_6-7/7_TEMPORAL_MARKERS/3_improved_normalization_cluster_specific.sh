#!/bin/bash
#SBATCH --job-name=3_improved_normalization_cluster_specific
#SBATCH --output=logs/3_improved_normalization_cluster_specific.out
#SBATCH --error=logs/3_improved_normalization_cluster_specific.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific
mkdir -p logs
...
python MERGE_SPATIAL_DATA/RUN_6-7/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific.py
...
if [ $? -eq 0 ]; then
    ...
    echo "- Individual cluster results: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/"
    echo "- Volcano plots: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/volcano_plot_*_cluster_*.png"
    echo "- Heatmaps: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/heatmap_*_cluster_*.png"
    echo "- Combined results: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/combined_cluster_de_results_all_timepoints.csv"
    echo "- Cluster summary: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/cluster_summary_statistics.csv"
    echo "- Summary plots: MERGE_SPATIAL_DATA/7_TEMPORAL_MARKERS/3_improved_normalization_cluster_specific/cluster_analysis_summary.png"
    echo "================================================================"
else
    echo "================================================================"
