#!/bin/bash
#SBATCH --job-name=cluster_pseudobulk_spatial_plots
#SBATCH --output=logs/cluster_pseudobulk_spatial_plots.out
#SBATCH --error=logs/cluster_pseudobulk_spatial_plots.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p MERGE_SPATIAL_DATA/6_GENE_SETS_SCORES/cluster_pseudobulk_spatial_plots
mkdir -p logs

# Run the analysis
echo "Running cluster pseudo-bulk gene set scoring and spatial visualization..."
python MERGE_SPATIAL_DATA/RUN_6-7/6_GENE_SETS_SCORES/cluster_pseudobulk_spatial_plots.py

echo "================================================================"
echo "Pipeline completed! Check the results in:"
echo "MERGE_SPATIAL_DATA/6_GENE_SETS_SCORES/cluster_pseudobulk_spatial_plots/"
echo "================================================================"
