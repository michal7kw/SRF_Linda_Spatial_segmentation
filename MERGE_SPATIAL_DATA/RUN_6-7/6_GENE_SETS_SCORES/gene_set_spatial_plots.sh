#!/bin/bash
#SBATCH --job-name=gene_set_spatial_plots
#SBATCH --output=logs/gene_set_spatial_plots.out
#SBATCH --error=logs/gene_set_spatial_plots.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p MERGE_SPATIAL_DATA/RUN_6-7/6_GENE_SETS_SCORES/gene_set_spatial_plots

# Run the analysis
echo "Running gene set scoring and spatial visualization..."
python MERGE_SPATIAL_DATA/RUN_6-7/6_GENE_SETS_SCORES/gene_set_spatial_plots.py

echo "================================================================"
echo "Pipeline completed! Check the results in:"
echo "MERGE_SPATIAL_DATA/RUN_6-7/6_GENE_SETS_SCORES/gene_set_spatial_plots/"
echo "================================================================"