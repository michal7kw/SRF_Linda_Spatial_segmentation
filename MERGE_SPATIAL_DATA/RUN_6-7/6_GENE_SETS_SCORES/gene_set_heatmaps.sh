#!/bin/bash
#SBATCH --job-name=gene_set_heatmaps
#SBATCH --output=logs/gene_set_heatmaps.out
#SBATCH --error=logs/gene_set_heatmaps.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p MERGE_SPATIAL_DATA/6_GENE_SETS_SCORES/gene_set_heatmaps

# Run the analysis
echo "Running gene set scoring and spatial visualization..."
python MERGE_SPATIAL_DATA/RUN_6-7/6_GENE_SETS_SCORES/gene_set_heatmaps.py

echo "================================================================"
echo "Pipeline completed! Check the results in:"
echo "MERGE_SPATIAL_DATA/6_GENE_SETS_SCORES/gene_set_heatmaps/"
echo "================================================================"