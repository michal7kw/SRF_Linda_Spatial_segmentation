...
output_dir = 'MERGE_SPATIAL_DATA/6_GENE_SETS_SCORES/gene_set_spatial_plots'
...
# %%
# Create spatial plots for each gene set and sample with consistent color scales per time point
