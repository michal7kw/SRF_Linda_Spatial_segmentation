#!/bin/bash
#SBATCH --job-name=2task_v2_original_parallel
#SBATCH --output=logs/2task_v2_original_parallel.out
#SBATCH --error=logs/2task_v2_original_parallel.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
PROJ_DIR="/beegfs/scratch/ric.sessa/kubacki.michal/SRF_Linda_top/SRF_Spatial_segmentation"
